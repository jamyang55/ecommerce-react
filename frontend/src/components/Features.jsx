...
import { featuresProducts } from "./assets";
    ...
    <>
      <div>
        <div className="flex ml-6 mr-20 mt-3 justify-between">
          <p className="text-xl font-semibold">Features Products</p>
        ...
        <div className="  grid grid-cols-5 cursor-pointer mr-8   ">
          {featuresProducts.map((item, index) => {
            return (
              <div key={index}>
                <div className="">
                  <img
                ...
                <div className=" shadow-md">
                  {" "}
                  <p className=" text-sm font-medium ml-6  hover:text-green-500 ">
                    {item.name}
                  </p>
                  <div className="flex text-sm ">
                    ...
                    <s className="pl-2 text-gray-500">{item.old}</s>
                  </div>
                  <div className="flex justify-between">
                    <img
                      src={item.rating}
                      alt=""
                      className="ml-5 w-8 h-2 mt-4"
                    />
